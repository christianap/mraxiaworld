...
public class GameClient extends Thread {
	...
	private void handleLogin(Packet00Login packet, InetAddress address, int port) {
		...
		PlayerMP player = new PlayerMP(gameScreen.level, packet.getX(), packet.getY(), packet.getUsername(), address, port, packet.getShirtColor(), packet.getSkinColor(), packet.getCharacterType());
